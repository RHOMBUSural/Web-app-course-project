...
public class OrdersController implements Serializable {
    ...
    @EJB
    private Facades.OrdersFacade ejbFacade;
    private PaginationHelper pagination;
    private int selectedItemIndex;
    
    private Integer ordersMin = 0;
    private Integer ordersMax = 0;
    List<Orders> resOrders;
    ...
    //ordersMin
    public int getOrdersMin() {
        return this.ordersMin;
    }

    public void setOrdersMin(int a) {
        this.ordersMin = a;
    }
    
    //ordersMax
    public int getOrdersMax() {
        return this.ordersMax;
    }

    public void setOrdersMax(int a) {
        this.ordersMax = a;
    }
    
    public String queryOrders_yes() {
        Integer[] params = new Integer[]{ordersMin, ordersMax};
    //System.out.println(params);
        resOrders = ejbFacade.findRangeOrders(params);
        return "resQOrder";
    }
    //Метод на чтение для запроса свойства контроллера;
    public List<Orders> getResOrders() {
        return resOrders;
    }
